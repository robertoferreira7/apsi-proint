...
CREATE TABLE public.fato_cvli (
	...
	total_cvli integer,
	CONSTRAINT fato_cvli_pk PRIMARY KEY (tempo,local,subjetividade,ambiente,instrumento,faixa_etaria,raca_cor,sexo)
);
-- ddl-end --
...
-- object: public.dim_local | type: TABLE --
-- DROP TABLE IF EXISTS public.dim_local CASCADE;
CREATE TABLE public.dim_local (
	pk_local integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ,
	fk_municipio integer NOT NULL,
	bairro varchar(255) NOT NULL,
	CONSTRAINT dim_local_pk PRIMARY KEY (pk_local)
);
-- ddl-end --
ALTER TABLE public.dim_local OWNER TO postgres;
-- ddl-end --
...
-- object: fk_dim_local | type: CONSTRAINT --
-- ALTER TABLE public.fato_cvli DROP CONSTRAINT IF EXISTS fk_dim_local CASCADE;
ALTER TABLE public.fato_cvli ADD CONSTRAINT fk_dim_local FOREIGN KEY (local)
REFERENCES public.dim_local (pk_local) MATCH SIMPLE
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
-- ALTER TABLE public.dim_local DROP CONSTRAINT IF EXISTS fk_dim_municipio CASCADE;
ALTER TABLE public.dim_local ADD CONSTRAINT fk_dim_municipio FOREIGN KEY (fk_municipio)
